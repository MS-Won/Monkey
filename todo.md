...
* [ ] **사용자 수동 1건 — Play Console 비공개 테스트 업로드**: 앱 생성은 2026-07-17 완료. 남은 것은 스토어 등록정보 → 앱 콘텐츠(데이터 안전 답변표) → 비공개 테스트 트랙에 `app-release.aab` 업로드(**versionCode 4 / targetSdk 36 재빌드본**) → 테스터 12명 등록. 복붙용 치트시트 `docs/release/play-console-checklist.md`.
